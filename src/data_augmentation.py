...
if __name__ == "__main__":
    ...
    script1 = '/home/giova/NLP/NLP_Project-main/src/manifest.py'
    result1 = subprocess.run(['python3', script1], capture_output=True, text=True)
    print(f"Uscita di {script1}:\n{result1.stdout}")
    if result1.stderr:
        print(f"Errori di {script1}:\n{result1.stderr}")
    input_directory = '/home/giova/NLP/NLP_Project-main/audio'          # Sostituisci con il tuo percorso di input
    output_directory = '/home/giova/NLP/NLP_Project-main/augmented_audio'  # Sostituisci con il tuo percorso di output
